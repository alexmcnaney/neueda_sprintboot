...
public class FloorAreaService {
	...
	public ArrayList<FloorArea> getfloorArea() {
		...
		buildings.add(afa);		
		FloorArea bcia = new FloorArea("6", "Beijing Capital International Airport Terminal 3","China","Beijing","10,610,000 sqft", "tvm.jpg");
		buildings.add(bcia);		
		FloorArea tvm = new FloorArea("7", "The Venetian Macao","Macau","Macau","10,500,000 sqft", "lol.jpg");
		buildings.add(tvm);		
		FloorArea scc = new FloorArea("8", "Sands Cotai Centrali","Macau","Macau","9,600,000 sqft", "lol.jpg");
		buildings.add(scc);
		FloorArea cws = new FloorArea("9", "Ciputra World Surabaya","Indonesia","Surabaya","8,100,000 sqft", "lol.jpg");
		buildings.add(cws);		
		FloorArea bts = new FloorArea("10", "Berjaya Times Square","Malaysia","Kuala Lumpur","7,500,000 sqft", "lol.jpg");
		buildings.add(bts);
